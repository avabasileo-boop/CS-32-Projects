...
#include "globals.h"
#include "Arena.h"
//Classes that we use function from: 
#include "Rabbit.h"    
#include "Player.h"    
#include "History.h"
...
//ADDED: accessor for history object 
//return a reference to the history object 

History& Arena::history() 
{   
    return m_history;    //It is implied that I am returning a reference because of the return type.
}
