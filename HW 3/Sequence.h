...
public:
    ...
    void swap(Sequence<ItemType>& other);                                                 //change 
...
// previous beginning of Sequence.cpp
// Implementation of non-inline 
...
template <typename ItemType>
typename Sequence<ItemType>::Node* Sequence<ItemType>::doErase(Sequence<ItemType>::Node* p)
{
